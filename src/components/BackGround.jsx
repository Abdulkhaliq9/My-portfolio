...
export default function BackGround() {
  return (
    <>
      <div className="canvas canvas-ocean">
        {" "}
        <svg
        ...
        >
          ...
          <defs>
            ...
            >
              {" "}
              <stop stopColor="#030303" stopOpacity="0.2"></stop>{" "}
              <stop offset="1" stopColor="#030303" stopOpacity="0"></stop>{" "}
            </radialGradient>{" "}
            <radialGradient
              id="paint1_radial_2_79"
              cx="0"
              cy="0"
              r="1"
              gradientUnits="userSpaceOnUse"
            ...
            >
              {" "}
              <stop stopColor="#030303" stopOpacity="0.3"></stop>{" "}
              <stop offset="1" stopColor="#030303" stopOpacity="0"></stop>{" "}
            </radialGradient>{" "}
            <linearGradient
              id="paint2_linear_2_79"
              x1="1478.5"
              y1="29"
              x2="724"
              y2="860.5"
            ...
            >
              {" "}
              <stop stopColor="#030303" stopOpacity="0.4"></stop>{" "}
              <stop offset="1" stopColor="#030303" stopOpacity="0"></stop>{" "}
            </linearGradient>{" "}
            <linearGradient
              id="paint3_linear_2_79"
              x1="1706"
              y1="27.9999"
              x2="908"
              y2="1064"
            ...
            >
              {" "}
              <stop stopColor="#030303" stopOpacity="0.7"></stop>{" "}
              <stop offset="1" stopColor="#030303" stopOpacity="0"></stop>{" "}
            </linearGradient>{" "}
            <linearGradient
              id="paint4_linear_2_79"
              x1="1836"
              y1="0.00011728"
              x2="1549"
              y2="1125"
            ...
            >
              {" "}
              <stop stopColor="#030303"></stop>{" "}
              <stop offset="1" stopColor="#030303" stopOpacity="0"></stop>{" "}
            </linearGradient>{" "}
            <linearGradient
              id="paint5_linear_2_79"
              x1="1894"
              y1="649"
              x2="1892"
              y2="895.5"
        ...
        <svg
          className="ocean-dark"
          viewBox="0 0 2000 1125"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          {" "}
          <g clipPath="url(#clip0_2_79_dark)">
            {" "}
            <rect width="2000" height="1125" fill="#030303"></rect>{" "}
            <path
              d="M1002.62 0H2000V1125H-1L4.46725 639.133L398.107 602.001C637.869 602.001 726.004 543.772 784.717 338.922C804.309 270.563 890.937 160.376 890.937 160.376C890.937 160.376 982.317 94.8034 1002.62 0Z"
          ...
          <defs>
            ...
            >
              {" "}
              <stop stopColor="#282828" stopOpacity="0.2"></stop>{" "}
            ...
            >
              {" "}
              <stop stopColor="#282828" stopOpacity="0.3"></stop>{" "}
              <stop offset="1" stopColor="#282828" stopOpacity="0"></stop>{" "}
            </radialGradient>{" "}
            <linearGradient
            ...
            >
              {" "}
              <stop stopColor="#282828" stopOpacity="0.4"></stop>{" "}
              <stop offset="1" stopColor="#282828" stopOpacity="0"></stop>{" "}
            </linearGradient>{" "}
            <linearGradient
            ...
            >
              {" "}
              <stop stopColor="#282828" stopOpacity="0.7"></stop>{" "}
              <stop offset="1" stopColor="#282828" stopOpacity="0"></stop>{" "}
            </linearGradient>{" "}
            <linearGradient
